...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <h1>In-Class Assessment 03 Web Forms</h1>
    </div>
     <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 text-left">
            ...
            <asp:CompareValidator ID="RegularExpressionStudentID" runat="server"
            ...
            <asp:RangeValidator ID="CompareCredits" runat="server" 
    ...
    <div class="row">
        <div class="col-md-4 text-right">
                <asp:Label ID="LabelCredits" runat="server" Text="Age"
